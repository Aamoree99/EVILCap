...
async function generateStalkerResponse(userMessage) {
    const payload = {
        ...
        messages: [
            { role: 'system', content: 'ответь в стиле персонажа из "Звездного пути". Включи атмосферные фразы и элементы научной фантастики, которые ассоциируются с "Звездным путем". Ответ максимум в 1-2 предложения.' },
