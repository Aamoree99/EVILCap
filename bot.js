...
const scheduledPhrases = [
    ...
    "Пока одни копают, умные пилоты делают тыловые операции. Присоединяйся! " + channelInfo,
    "Тыловые операции: меньше рисков, больше доходов. Ты нам нужен! " + channelInfo,

    // Бездны
    "Бездны зовут! Опробуйте свою удачу и навыки в абиссальных глубинах. " + channelInfo,
    "Готов к вызову? Бездны ждут тебя! " + channelInfo,
    "Прыгай в бездны, если хочешь адреналина и наград! " + channelInfo,
    "Исследуй бездны и находи редкие артефакты. " + channelInfo,
    "Бездны: где награды оправдывают риски. " + channelInfo,
    "Стань мастером абиссальных глубин, вступи в бездны! " + channelInfo,
    "Пора прокачать скиллы в безднах. Ты справишься! " + channelInfo,
    "Готов к эпическим битвам и сокровищам? Добро пожаловать в бездны. " + channelInfo,
    "Бездны: там, где легенды становятся реальностью. " + channelInfo,
    "Твои лучшие моменты в игре ждут тебя в безднах. " + channelInfo,

    // Фракционные войны
    "Фракционные войны зовут! Защищай честь своего фракционного дома! " + channelInfo,
    "Вступай в фракционные войны и покажи, на что ты способен! " + channelInfo,
    "Твой фракционный дом нуждается в тебе. Вступай в бой! " + channelInfo,
    "Фракционные войны: где герои становятся легендами. " + channelInfo,
    "Стань частью эпической битвы в фракционных войнах. " + channelInfo,
    "Защищай свою фракцию и завоевывай новые территории! " + channelInfo,
    "Твои навыки и стратегия могут изменить ход фракционных войн. Присоединяйся! " + channelInfo,
    "Фракционные войны: время для великих побед и сражений. " + channelInfo,
    "Стань героем фракционных войн и впиши свое имя в историю! " + channelInfo,
    "Твоя фракция нуждается в тебе. Время для великих подвигов! " + channelInfo,
    "Защищай честь и слава твоей фракции в войнах! " + channelInfo,
