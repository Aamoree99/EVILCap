...
async function respondToMessage(message, pingUser = false) {
    const payload = {
        model: 'gpt-3.5-turbo-0125',
        messages: [
            { role: 'system', content: 'Вы - абсурдный и смешной помощник Артемка в корпорации EVE Online. Отвечайте на вопросы с точки зрения нелепого и забавного персонажа, используя абсурдный и юмористический стиль. Ответы должны быть на русском языке и максимально нелепыми и смешными, не более 3-4 предложений.' },
